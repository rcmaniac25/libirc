...
*/
#ifndef __IRC_RPL_H__
#define __IRC_RPL_H__
/* This file was autogenerated from http://www.irchelp.org/irchelp/rfc/chapter6.html */

/*
 * Symbol definitions (for use with callback registration)
 */
