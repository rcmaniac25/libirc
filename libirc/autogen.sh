...
if [ "x$_report_error" = "xyes" ] ; then
  echo "ERROR:  To prepare the libIRC build system from scratch,"
...
##################################################
if [ ! "x$ARGS" = "x" ] ; then
  echo "The libIRC build system is now prepared.  Building here with:"
...
echo "The libIRC build system is now prepared.  To build here, run:"
